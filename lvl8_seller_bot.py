...
# Supabase - Stable Cloud Pooler (IPv4 Compatible for Render)
DB_URL = 'postgresql://postgres.opseljsvrnclsohcsqiq:supra%40ultimat@aws-1-ap-northeast-1.pooler.supabase.com:6543/postgres'
